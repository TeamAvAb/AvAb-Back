...
public class AuthServiceImpl implements AuthService {
    ...
    public OAuthResponse kakaoLogin(String code) {
        ...
        KakaoProfile kakaoProfile = kakaoAuthProvider.requestKakaoProfile(oAuthToken.getAccess_token());

        // 유저 정보 받기
        Optional<User> queryUser = userRepository.findByEmailAndSocialType(kakaoProfile.getKakao_account().getEmail(), SocialType.KAKAO);
