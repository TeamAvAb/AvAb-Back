...
public class FlowViewCountLast7DaysRepositoryImpl extends BaseRedisRepository<Long>
        implements FlowViewCountLast7DaysRepository {
    ...
    @Override
    protected Long extractId(String key) {
